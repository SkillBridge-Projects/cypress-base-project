describe('Create a Task in the Application', () => {
    ...
    it('should create issue by filling the first field', () => {
        // Step 4: Fill the first field and attempt to create an issue
        cy.get('[data-testid="select:type"]').click() // Click to select issue type
            .parent() // Locate the dropdown's parent
            .find('div') // Find divs inside the dropdown
            .contains('Bug') // Select the 'Bug' issue type
            .click() // Click to select
            .wait(1000); // Wait for the selection to complete
