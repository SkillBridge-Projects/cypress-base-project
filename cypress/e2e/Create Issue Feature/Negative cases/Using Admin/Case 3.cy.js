describe('Create a Task in the Application', () => {
    ...
    it('should create issue by filling the first field', () => {
        // Step 4: Create an issue by filling in the first field and submitting
        ...
        cy.get('[data-testid="Issue Create:short-summary"]').type('$12345@'); // Enter summary with invalid characters
