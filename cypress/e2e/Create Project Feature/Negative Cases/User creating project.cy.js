describe('User Creating Project Feature', () => { 
    ...
    it('should log in to the site', () => { 
        ...
        cy.get('input[name="email"]').type('lakisha@mail.com'); // Enter email 

        cy.wait(1000); // Wait to ensure input is typed 

        cy.get('input[name="password"]').type('lakisha'); // Enter password 
    ...
    // Step 2: User creating a new project with validation checks 
